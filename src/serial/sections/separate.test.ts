import {
    ...
    separateFourMergedSHA512Text_16,
...
describe('separateTwoMergedSHA512Text_16', () => {
    it('valid/lower', () => {
        expect(separateFourMergedSHA512Text_16('a'.repeat(512))).toStrictEqual(
            Array.from({ length: 16 }, () => 'a'.repeat(32))
        );
    });
    it('valid/upper', () => {
        expect(separateFourMergedSHA512Text_16('A'.repeat(512))).toStrictEqual(
    ...
    it('invalid/length error', () => {
        expect(() => separateFourMergedSHA512Text_16('a'.repeat(511))).toThrow('invalid two merged SHA512 text');
    });
    it('invalid/character error', () => {
        expect(() => separateFourMergedSHA512Text_16('g'.repeat(512))).toThrow('invalid two merged SHA512 text');
    });
});

describe('separateNumTextToMax4Digit', () => {
    it('valid 1', () => {
        expect(separateNumTextToMax4Digit('12345678901234567890')).toStrictEqual([
            '1234',
            '5678',
            '9012',
            '3456',
    ...
    it('valid 2', () => {
        expect(separateNumTextToMax4Digit('1234567890123456789')).toStrictEqual([
            '1234',
            '5678',
            '9012',
            '3456',
